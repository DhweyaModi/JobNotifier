from scrapers.simplify import (
    fetch_simplify_jobs,
    fetch_simplify_newgrad_jobs,
)
...
from scrapers.speedyapply import (
    ...
    fetch_speedyapply_swe_newgrad_jobs,
    fetch_speedyapply_ai_newgrad_jobs,
)

SCRAPERS = [
    (fetch_google_jobs, "Google"),
    (fetch_simplify_jobs, "SimplifyJobs-Internships"),
    (fetch_simplify_newgrad_jobs, "SimplifyJobs-NewGrad"),
    ...
    (fetch_speedyapply_swe_newgrad_jobs, "SpeedyApply-SWE-NewGrad"),
    (fetch_speedyapply_ai_newgrad_jobs, "SpeedyApply-AI-NewGrad"),
]
